...
func (b *Bot) generateAuthorizationLink(chatID int64) (string, error) {
	redirectURL := b.generateAuthServiceRedirectLink(chatID)
...
func (b *Bot) generateAuthServiceRedirectLink(chatID int64) string {
...
func (b *Bot) initAuthorizationProcess(message *tgbotapi.Message) error {
	...
	msg := tgbotapi.NewMessage(message.Chat.ID, fmt.Sprintf(b.config.Messages.Responses.Start, authLink))
